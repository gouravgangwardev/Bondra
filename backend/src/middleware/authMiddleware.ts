...
export const adminMiddleware = async (
  ...
  // Bug 4 fix: fetch full user record and check the is_admin column.
  // Checking req.user.username === 'admin' is a security bypass — anyone
  // who registers with the username "admin" would pass.
