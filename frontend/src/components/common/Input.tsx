      ...
      {label && (
        <label
          ...
          className={`
            ...
            ${error ? 'text-red-400' : isFocused ? 'text-primary' : 'text-text-secondary'}
          `}
        >
          {label}
        </label>
        ...
        <input
          ...
          className={`
            ...
            ${error
              ...
              : `border-border-default focus:border-primary/60
        ...
        {(rightIcon || isPassword) && (
          <button
            ...
            className={`
              ...
              ${error ? 'text-red-400 hover:text-red-300' : 'text-text-secondary hover:text-text-secondary'}
              focus:outline-none
            `}
            tabIndex={-1}
          >
